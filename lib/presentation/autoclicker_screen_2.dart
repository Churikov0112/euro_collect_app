...
class AutoclickerScreen2 extends StatefulWidget {
  const AutoclickerScreen2({super.key});

  @override
  AutoclickerScreen2State createState() => AutoclickerScreen2State();
}

class AutoclickerScreen2State extends State<AutoclickerScreen2> with SingleTickerProviderStateMixin {
  @override
  void initState() {
    super.initState();
